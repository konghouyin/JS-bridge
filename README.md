...
- 相关代码路径：/pages/public_module/checkFunction.js

这个模块主要负责js-bridge交互中的，检测回调函数的合法性。检测js-bridge调用过程中，回调函数的参数可以缺省，但不能是非函数参数。

### 4.获取系统权限

- 相关代码路径：/pages/public_module/getSystemInfo.js

获取android和ios的移动设备的系统信息
