<template>
    <div class="all">
        <div class="nav">
            <ul @click="switchVue($event)">
                <li name="mine" v-bind:class="click=='mine'?'active':''" value="1">我的</li>
                <li name="find" v-bind:class="click=='find'?'active':''" value="2">发现</li>
                <li name="rankingList" v-bind:class="click=='rankingList'?'active':''" value="3">热度</li>
